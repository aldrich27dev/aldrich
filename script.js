...
// cursorAnim
let cursor = document.querySelector('.animCursor');
let cursor2 = document.querySelector('.animCursor2');
        ...
        Material: {
          ...
          value: class {
            constructor(e, n, t = {}) {
              ...
              (i.uniforms = t), (i.uniformInstances = []);
              ...
              (i.vertexSource = `\n              ${l}\n              attribute vec4 position;\n              attribute vec2 uv;\n              attribute vec2 uvNorm;\n              ${a(
                ...
                r.getProgramParameter(i.program, r.LINK_STATUS) ||
                  console.error(r.getProgramInfoLog(i.program)),
            ...
            attachUniforms(e, n) {
              ...
              void 0 === e
                ...
                : 'array' == n.type
                ? n.value.forEach((n, i) => t.attachUniforms(`${e}[${i}]`, n))
                : 'struct' == n.type
                ? Object.entries(n.value).forEach(([n, i]) =>
                    t.attachUniforms(`${e}.${n}`, i)
                  )
                : (s.debug('Material.attachUniforms', { name: e, uniform: n }),
            ...
            constructor(e, n, t, i, o) {
              r.createBuffer(),
                (this.attributes = {
                  ...
                  uv: new s.Attribute({ target: r.ARRAY_BUFFER, size: 2 }),
                  uvNorm: new s.Attribute({ target: r.ARRAY_BUFFER, size: 2 }),
            ...
            setSize(e = 1, n = 1, t = 'xz') {
              ...
              (i.width = e),
                ...
                (i.attributes.position.values &&
                  i.attributes.position.values.length === 3 * i.vertexCount) ||
              ...
              for (let e = 0; e <= i.ySegCount; e++) {
                ...
                for (let s = 0; s <= i.xSegCount; s++) {
                  const r = o + s * a,
                    l = e * (i.xSegCount + 1) + s;
                  (i.attributes.position.values[3 * l + 'xyz'.indexOf(t[0])] =
                    r),
                    (i.attributes.position.values[3 * l + 'xyz'.indexOf(t[1])] =
                      -n);
                }
              }
          ...
          value: class {
            constructor(e, n) {
              ...
              (t.geometry = e),
                ...
                Object.entries(t.geometry.attributes).forEach(([e, n]) => {
